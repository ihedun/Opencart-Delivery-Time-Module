    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="panel-group" id="accordion">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-collapse collapse" id="collapse-shipping-address1">
            <div class="panel-body"></div>
          </div>    
        ...
        <div class="panel panel-default">
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title"><?php echo $text_checkout_delivery_time; ?></h4>
          </div>
          <div class="panel-collapse collapse" id="collapse-timeslot">
            <div class="panel-body"></div>
          </div>
        </div>
        <?php } ?>
            ...
            if (json['redirect']) {
                ...
                $.ajax({
                    ...
                    success: function(html) {
                        ...
                        $('#collapse-timeslot .panel-body').html(html);
                        ...
                        $('a[href=\'#collapse-timeslot\']').trigger('click');
    ...
    $.ajax({
        ...
        success: function(json) {
            ...
            if(json=='fulled'){
                ...
                //alert("Please select another slot because this time is full");
                return false;
        }else{
